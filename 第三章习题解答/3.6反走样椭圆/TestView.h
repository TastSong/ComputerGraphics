...
public:
	...
	void DrawAEllipse(CDC *);//绘制反走样椭圆函数
	void AEllipsePointAC(CDC *,CP2,double);//四分法画椭圆AC子函数
	void AEllipsePointBC(CDC *,CP2,double);//四分法画椭圆BC子函数
	virtual ~CTestView();
#ifdef _DEBUG

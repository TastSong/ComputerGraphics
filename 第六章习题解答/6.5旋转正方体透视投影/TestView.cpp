...
void CTestView::ReadPoint()//点表
{
	double a=100;//正方体边长
	//顶点的三维坐标(x,y,z)
	P[0].x=-a;P[0].y=-a;P[0].z=-a;P[0].c=CRGB(1.0,0.0,0.0);
	P[1].x=a; P[1].y=-a;P[1].z=-a;P[1].c=CRGB(0.0,1.0,0.0);
	P[2].x=a; P[2].y=a; P[2].z=-a;P[2].c=CRGB(0.0,0.0,1.0);
	P[3].x=-a;P[3].y=a; P[3].z=-a;P[3].c=CRGB(1.0,1.0,0.0);
	P[4].x=-a;P[4].y=-a;P[4].z=a;P[4].c=CRGB(1.0,0.0,1.0);
	P[5].x=a; P[5].y=-a;P[5].z=a;P[5].c=CRGB(0.0,0.0,0.0);
	P[6].x=a; P[6].y=a; P[6].z=a;P[6].c=CRGB(1.0,1.0,1.0);
	P[7].x=-a;P[7].y=a; P[7].z=a;P[7].c=CRGB(0.0,1.0,1.0);
}

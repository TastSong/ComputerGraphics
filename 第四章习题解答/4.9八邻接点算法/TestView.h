...
public:
	...
	void Push(CPoint point);//入栈函数
	CStack_Node *Pop();//出栈函数
// Overrides
...
protected:
	CPoint Point[9];//定义多边形
	CPoint Seed;//种子
	CPoint PLeft,PTop,PRight,PBottom,PLeftTop,PRightTop,PRightBottom,PLeftBottom;//邻接点
	CStack_Node *Head,*Base,*Last;//结点指针

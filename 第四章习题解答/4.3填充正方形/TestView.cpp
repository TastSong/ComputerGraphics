...
void CTestView::ReadPoint()//点表
{
	int a=160;
	//读入第一个正方形的上三角顶点坐标
	P1[0]=CP2(MaxX/4-a,MaxY/2+a);//P1
	P1[1]=CP2(MaxX/4+a,MaxY/2-a);//P2
	P1[2]=CP2(MaxX/4-a,MaxY/2-a);//P3
	//读入第一个正方形的下三角顶点坐标
	P2[0]=CP2(MaxX/4-a,MaxY/2+a);
	P2[1]=CP2(MaxX/4+a,MaxY/2+a);
	P2[2]=CP2(MaxX/4+a,MaxY/2-a);
	//读入第二个正方形的左三角顶点坐标
	P3[0]=CP2(3*MaxX/4-a,MaxY/2+a);
	P3[1]=CP2(3*MaxX/4+a,MaxY/2+a);
	P3[2]=CP2(3*MaxX/4-a,MaxY/2-a);
	//读入第二个正方形的右三角顶点坐标
	P4[0]=CP2(3*MaxX/4+a,MaxY/2+a);
	P4[1]=CP2(3*MaxX/4+a,MaxY/2-a);
	P4[2]=CP2(3*MaxX/4-a,MaxY/2-a);
}

...
// Operations
public:
	void GetMaxX();//获得屏幕宽度函数
	void GetMaxY();//获得屏幕长度函数
	void DrawPoint();//绘制型值点函数
	void ParaSpline();//绘制三次参数样条函数
	void SinCurve();//绘制正弦曲线
// Overrides
...
protected:
	//{{AFX_MSG(CTestView)
	afx_msg void OnMENUParaSpline();
	afx_msg void OnMENUSin();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};

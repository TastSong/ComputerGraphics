...
// Operations
public:
	void GetMaxX();//获得屏幕最大x值函数
    void GetMaxY();//获得屏幕最大y值函数
...
protected:
	int MaxX,MaxY;//屏幕最大值
	double ax,ay;//起点坐标
	CString Axiom,Rule,NewRule,NewRuleTemp;//文法模型参数
	CStateNode Stack[1024];//堆栈数组
	int	StackPushPos;//堆栈数组元素位置

...
// Operations
public:
	void Cubicf(CDC *,CP2,double);//绘制立方体前
	void Cubict(CDC *,CP2,double);//绘制立方体顶面
	void Cubicr(CDC *,CP2,double);//绘制立方体右面
	void Sponge(CDC *,int,CP2,double);//绘制海绵
// Overrides

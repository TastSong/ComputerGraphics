...
public:
	...
	void ReadCube();//读入正方体顶点
	int  Maxnum(int *, int);//顶点最大值
	void Fill(POINT*, POINT*, POINT*, int, int, int);//填充函数
	void DrawCube();//绘制正方体
// Overrides
...
protected:
	//{{AFX_MSG(CTestView)
	afx_msg void OnMENURotatecube();
	afx_msg void OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags);
	afx_msg void OnTimer(UINT nIDEvent);
	afx_msg void OnUpdateMENURotatecube(CCmdUI* pCmdUI);
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};

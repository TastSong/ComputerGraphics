...
void CTestView::ReadFace()//面表
{
	...
	F[2].En=3;F[2].p[0]=0;F[2].p[1]=3;F[2].p[2]=4;
	F[3].En=3;F[3].p[0]=0;F[3].p[1]=4;F[3].p[2]=1;
	F[4].En=3;F[4].p[0]=5;F[4].p[1]=2;F[4].p[2]=1;
	F[5].En=3;F[5].p[0]=5;F[5].p[1]=3;F[5].p[2]=2;
	F[6].En=3;F[6].p[0]=5;F[6].p[1]=4;F[6].p[2]=3;
	F[7].En=3;F[7].p[0]=5;F[7].p[1]=1;F[7].p[2]=4;
}

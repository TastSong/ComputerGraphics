...
{
	//顶点的三维坐标(x,y,z)
	P[0].x=200; P[0].y=-50;P[0].z=100; 
	P[1].x=200; P[1].y=50; P[1].z=100;  
	P[2].x=-200;P[2].y=50; P[2].z=100;
	P[3].x=-200;P[3].y=-50;P[3].z=100;
	P[4].x=-200;P[4].y=-50;P[4].z=-100;
	P[5].x=200; P[5].y=-50;P[5].z=-100; 
	P[6].x=200; P[6].y=50; P[6].z=-100;
	P[7].x=150; P[7].y=150;P[7].z=0;   
	P[8].x=-150;P[8].y=150;P[8].z=0;   
	P[9].x=-200;P[9].y=50; P[9].z=-100;
}

void CTestView::ReadFace()//面表
{
	//面的边数、面的顶点编号
	F[0].En=4;F[0].p[0]=0;F[0].p[1]=1;F[0].p[2]=2;F[0].p[3]=3;
	F[1].En=4;F[1].p[0]=0;F[1].p[1]=5;F[1].p[2]=6;F[1].p[3]=1;
	F[2].En=3;F[2].p[0]=1;F[2].p[1]=6;F[2].p[2]=7;
	F[3].En=4;F[3].p[0]=1;F[3].p[1]=7;F[3].p[2]=8;F[3].p[3]=2;
	F[4].En=4;F[4].p[0]=0;F[4].p[1]=3;F[4].p[2]=4;F[4].p[3]=5;
	F[5].En=4;F[5].p[0]=6;F[5].p[1]=9;F[5].p[2]=8;F[5].p[3]=7;
	F[6].En=3;F[6].p[0]=2;F[6].p[1]=8;F[6].p[2]=9;
	F[7].En=4;F[7].p[0]=9;F[7].p[1]=4;F[7].p[2]=3;F[7].p[3]=2;
	F[8].En=4;F[8].p[0]=4;F[8].p[1]=9;F[8].p[2]=6;F[8].p[3]=5;
}
